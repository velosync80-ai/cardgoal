      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-8">
            ...
            <div className="bg-green-500 text-white rounded-xl p-6 py-4 max-w-xl">
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <div className="bg-slate-800 text-white rounded-xl p-6 py-4 max-w-xl self-start">
              <h3 className="font-bold mb-2">
            ...
            <div className="bg-green-500 text-white rounded-xl p-6 py-4  max-w-xl self-end">
              <h3 className="font-bold mb-2">
             3. What is the best app to sell gift cards in Nigeria?
              </h3>
              <p className="text-sm">
                Cardgoal is widely recognized as the best app to sell gift cards due to its simple interface, high rates, instant payouts, and additional rewards like referral bonuses and daily coins.
              </p>
            </div>

           <div className="bg-slate-800 text-white rounded-xl p-6 py-4 max-w-xl self-start relative">
            ...
            <div className="bg-green-500 text-white rounded-xl p-6 py-4 max-w-xl self-end">
              <h3 className="font-bold mb-2">
              5. How fast is the payout when I sell gift cards in Nigeria?
              </h3>
              <p className="text-sm">
