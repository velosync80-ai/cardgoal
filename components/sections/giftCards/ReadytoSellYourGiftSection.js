      ...
      <div className="max-w-7xl h-80 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 ">
          <div className="text-white md:pt-20">
            <h2 className="text-4xl md:text-4xl font-bold mb-6 text-white lexend-bold">
            ...
            <Link
              ...
              onClick={() => trackEvent('click_get_app_sell_page_bottom', 'CTA Click', 'Sell Gift Card - Bottom Banner')} >
