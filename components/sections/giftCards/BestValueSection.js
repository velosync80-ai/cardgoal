      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex overflow-x-auto gap-6 scroll-smooth">
          ...
          {[
            ...
            { img: '/images/star.png', title: 'Use Trust & Referral Bonuses', text: 'Every trade on Cardgoal can unlock extra rewards, and referring friends earns you 500 Naira per referral. Combine these perks to boost the overall cash you earn from selling your gift cards.' },
