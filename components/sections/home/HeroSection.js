          ...
          <div className="text-white">
            ...
            {/* <div className="flex flex-col sm:flex-row gap-4"> */}
              <Link
                ...
                className="theme-dark-bg inline-flex items-center gap-3 text-xl md:text-xl text-white px-3 py-2 rounded Lexend-Medium transition-colors"
                onClick={() =>
                  trackEvent(
